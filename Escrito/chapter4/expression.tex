...
%Cuando se utiliza una constante enumerada, es necesario consultar el respectivo contexto de tipos definidos.
...
%Las siguientes reglas nos permitirán chequear la aplicación de los operadores de variables.
...
%es necesario verificar que todas las expresiones sean de tipo entero, y que su cantidad coincida con las dimensiones que posee la estructura.
...
% Disponemos de las reglas para expresiones y sentencias
...
Un ejemplo es la declaración de un sinónimo de tipo $\T{syn} \; tn = \theta$. %por parte del usuario, junto con el tipo especificado en el cuerpo de su definición.
...
Las otras reglas más relevantes de todo este contexto son las que nos permiten probar la equivalencia de un sinónimo de tipo con el tipo que lo define.
%La razón por la cual se formalizó el concepto de equivalencia de tipos, es para las siguientes reglas sobre los sinónimos de tipo del lenguaje. 
...
%Adicionalmente se debe aplicar
...
%, contamos con las herramientas necesarias para demostrar la validez de la asignación en cuestión.
...
% Prueba Eliminada: Lista en isEmpty
\iffalse
\begin{Prueba}
\label{PETLista}
